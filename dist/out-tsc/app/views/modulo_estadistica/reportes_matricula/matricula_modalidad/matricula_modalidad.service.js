...
var MatriculaModalidadService = /** @class */ (function () {
    //RequestService constructor: Http reference
    function MatriculaModalidadService(http) {
        this.http = http;
        //Port where the backend server is  running
        this.baseUrl = "http://localhost:8000";
    }
    //get_matricula_general function
    MatriculaModalidadService.prototype.get_matricula_general = function (payload) {
    ...
    MatriculaModalidadService.prototype.extractData = function (res) {
        var body = res.json();
        return body || [];
    };
    //Handle and print error
    MatriculaModalidadService.prototype.handleError = function (error) {
        var errMsg = (error.message) ? error.message :
            error.status ? error.status + " - " + error.statusText : 'Server error';
        console.error(errMsg); // log to console instead
        return Observable_1.Observable.throw(errMsg);
    };
    MatriculaModalidadService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http])
    ], MatriculaModalidadService);
    return MatriculaModalidadService;
}());
exports.MatriculaModalidadService = MatriculaModalidadService;
//# sourceMappingURL=matricula_modalidad.service.js.map